...
; CAHP-LABEL: andi:
; CAHP:       # %bb.0:
; CAHP-NEXT:    andi a0, a0, 6
; CAHP-NEXT:    jr ra
  %1 = and i16 %a, 6
  ret i16 %1
}

define i16 @lsli(i16 %a) nounwind {
; CAHP-LABEL: lsli:
; CAHP:       # %bb.0:
; CAHP-NEXT:    lsli a0, a0, 7
; CAHP-NEXT:    jr ra
  %1 = shl i16 %a, 7
  ret i16 %1
}

define i16 @lsri(i16 %a) nounwind {
; CAHP-LABEL: lsri:
; CAHP:       # %bb.0:
; CAHP-NEXT:    lsri a0, a0, 8
; CAHP-NEXT:    jr ra
  %1 = lshr i16 %a, 8
  ret i16 %1
}

define i16 @asri(i16 %a) nounwind {
; CAHP-LABEL: asri:
; CAHP:       # %bb.0:
; CAHP-NEXT:    asri a0, a0, 9
; CAHP-NEXT:    jr ra
  %1 = ashr i16 %a, 9
  ret i16 %1
}
